...
var (
	MysqlGetter MetadataGetter = MetadataGetter{
		getMysqlTables,
	}
)

func getMysqlTables(src string) ([]*core.Table, error) {
	...
	stmts, err := tidbparser.New().Parse(string(bs), "", "")
...
func ct(cs *ast.CreateTableStmt) (*core.Table, error) {
